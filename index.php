                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="text-success" href="leer.php?codigo=<?php echo $dato->codigo; ?>"><i class="bi bi-blockquote-right"></i></a></td>
            ...
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrar.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="txtSistema" autofocus required>
                    </div>
                    <div class="d-grid">
